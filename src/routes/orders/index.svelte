...
import Swal from "sweetalert2";
    ...
    const startRide =async (order: Iorder)=>{
     try {
        const orderResp = await axios.put(`${url}/order/accept_order_dispatcher?id=${order._id}`,{}, {
                        headers: {
    ...
    onMount(async () => {
        try {
            ...
            const orderResp = await axios.get(
                ...
                if(orderResp){
                     handleNotification('orders retrieved successfully', window, 'success', 'ok');
       ...
       <div class="col-12">
           <div class="card card-body">
               ...
               <div class="row mt-0">
                   <div class="col-9">
                       <div class="row">
                           <div class="col-1"><span class="order-status" /></div>
                           <div class="col-10 pt-0"> <span class="order-description "
                  ...
                  <button on:click="{()=>{startRide(order)}}" class="btn btn-outline btn-sm btn-success">start</button>
                   </div>
               </div>
       ...
       <div class="col-12">
           <div class="card card-body">
               ...
               <div class="row mt-0">
                  ...
                  <button on:click="{()=>{continueRide(order)}}" class="btn btn-outline btn-sm btn-success">continue</button>
                   </div>
               </div>
