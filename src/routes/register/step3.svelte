<script>
    ...
    const submit = async () => {
        ...
        if(!(pp && id)) return   handleNotification('please upload the required documents', window,'error', 'error');
        ...
        try {
            const driverResp = await axios.put(
                `${url}/accounts/driver_id`,
                form
            );
            if (driverResp) {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <span
                                on:click={activateId}
                                class="button outline float-end"
                                ><span class="fa fa-plus bordered mr-2" /> Upload
                                a file</span
                            >
                        </div>
                    </div>
